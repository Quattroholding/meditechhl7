            ...
            <div class="px-6 py-8">
                <div class="prose max-w-none space-y-6 text-gray-700">
                    ...
                    <section>
                        ...
                        <p>SAMI es una plataforma tecnológica destinada para facilitar la gestión administrativa y clínica de profesionales de la salud, consultorios, clínicas y establecimientos de servicios médicos.</p>
                    ...
                    <section>
                        ...
                        <p>El acceso a SAMI está reservado a usuarios debidamente registrados y autorizados por el cliente que haya contratado el servicio.</p>
                        <p>Cada usuario deberá utilizar sus propias credenciales de acceso y no podrá compartirlas con terceros. El usuario será responsable de mantener la confidencialidad de sus credenciales y de informar inmediatamente cualquier uso no autorizado de su cuenta.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>El usuario reconoce que la información relacionada con pacientes puede constituir información personal sensible y datos relacionados con la salud.</p>
                        <p>El usuario únicamente deberá acceder y utilizar dicha información cuando esté autorizado para hacerlo y cuando resulte necesario para el desempeño de sus funciones. El usuario deberá mantener la confidencialidad de la información a la que tenga acceso mediante SAMI.</p>
                    </section>

                    <section>
                        <h2 class="text-xl font-semibold text-gray-900 mb-3">5. INFORMACIÓN INGRESADA POR EL USUARIO</h2>
                        <p>El usuario será responsable de procurar que la información que introduzca en SAMI sea correcta, completa y adecuada para la finalidad correspondiente.</p>
                    ...
                    <section>
                        ...
                        <p>SAMI proporciona herramientas tecnológicas para facilitar la administración electrónica de información clínica.</p>
                        <p>El uso de SAMI no sustituye las obligaciones profesionales, éticas, legales o regulatorias que correspondan a los profesionales de la salud respecto de la elaboración, actualización, integridad, custodia y conservación de la historia clínica. El usuario deberá utilizar las funcionalidades de historia clínica de conformidad con las obligaciones que le resulten aplicables.</p>
                    </section>

                    <section>
                        <h2 class="text-xl font-semibold text-gray-900 mb-3">7. RESPONSABILIDAD MÉDICA</h2>
                        <p>SAMI no presta servicios médicos. La plataforma no sustituye el criterio profesional del médico ni constituye por sí misma diagnóstico, tratamiento, prescripción o recomendación médica. Toda decisión relacionada con la atención de un paciente deberá ser adoptada por el profesional de la salud correspondiente.</p>
                    </section>

                    <section>
                        <h2 class="text-xl font-semibold text-gray-900 mb-3">8. FUNCIONALIDADES DE INTELIGENCIA ARTIFICIAL</h2>
                        <p>Cuando SAMI disponga de funcionalidades basadas en inteligencia artificial, estas tendrán carácter de apoyo tecnológico.</p>
                        <p>Los resultados, sugerencias, análisis o información generados por dichas herramientas deberán ser revisados y evaluados por el profesional correspondiente antes de ser utilizados en la atención de un paciente. El usuario reconoce que los sistemas de inteligencia artificial pueden generar resultados incompletos, incorrectos o imprecisos. El usuario no deberá considerar dichos resultados como sustitutos de su criterio profesional.</p>
                    </section>

                    <section>
                        <h2 class="text-xl font-semibold text-gray-900 mb-3">9. SEGURIDAD</h2>
                        <p>El usuario deberá adoptar medidas razonables para proteger sus credenciales, dispositivos y accesos a SAMI. Cuando tenga conocimiento de una vulneración, pérdida de credenciales o acceso no autorizado, deberá comunicarlo inmediatamente al administrador correspondiente y/o a SAMI.</p>
                    ...
                    <section>
                        ...
                        <p>El tratamiento de los datos personales se realizará conforme a la legislación aplicable y a la Política de Privacidad de SAMI.</p>
                        <p>Cuando el usuario acceda a información de pacientes por cuenta del cliente, deberá utilizarla exclusivamente para las finalidades autorizadas y relacionadas con sus funciones. El usuario no podrá copiar, descargar, divulgar o utilizar información de pacientes para fines personales o ajenos a sus funciones.</p>
                    </section>

                    <section>
                        <h2 class="text-xl font-semibold text-gray-900 mb-3">11. PROPIEDAD INTELECTUAL</h2>
                        <p>SAMI y todos sus elementos tecnológicos, incluyendo software, código, interfaces, diseños, marcas, contenidos, funcionalidades y documentación, pertenecen a SAMI o a sus respectivos licenciantes.</p>
                    ...
                    <section>
                        ...
                        <p>SAMI procurará mantener la plataforma disponible y operativa.</p>
                    ...
                    <section>
                        ...
                        <p>SAMI podrá actualizar estos Términos cuando resulte necesario por cambios en la plataforma, nuevas funcionalidades, modificaciones regulatorias o mejoras en sus servicios. Cuando los cambios sean materiales, SAMI podrá comunicarlos mediante la plataforma, correo electrónico u otros medios disponibles.</p>
                    ...
                    <section>
                        ...
                        <p>Estos Términos forman parte del marco contractual de SAMI y complementan el Contrato de Suscripción y Prestación de Servicios y el Anexo de Tratamiento y Protección de Datos.</p>
                        <p>En caso de contradicción:</p>
                        <ul class="list-disc ml-6 mt-2 space-y-1">
