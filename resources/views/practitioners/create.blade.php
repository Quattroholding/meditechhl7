                ...
                <div class="col-sm-12">
                    @cannot('create',auth()->user())
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            {!! __('user.plan_error_message',['link'=>"<a class='btn btn-primary' href='".route('suscriptions.show')."'>click aqui</a>"]) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-6 col-xl-6">
                                        <div class=" input-block  local-forms ">
                                            ...
                                            <x-text-input id="id_number" class="block mt-1 w-full" type="text" name="id_number" :value="old('id_number')" autofocus/>
                                    ...
                                    <div class=" col-6 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            <div class="form-group local-forms cal-icon">
                                                ...
                                                <x-text-input id="birth_date" class="block mt-1 w-full datetimepicker" type="text" name="birth_date" :value="old('birth_date')"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-12 col-md-12 col-xl-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <x-textarea-input id="address" class="block mt-1 w-full" type="text" name="address">{{old('address')}}</x-textarea-input>
