                                ...
                                <div class="modal-content modal-md">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="input-block local-forms">
                                            ...
                                            <x-select-input name="patient_id" :options="\App\Models\Patient::get()->pluck('name','id')->toArray()"  class="block w-full"/>
                                        ...
                                        <div class="input-block local-forms">
                                            ...
                                            <x-text-input id="service_type" class="block mt-1 w-full" type="date" name="service_type" />
                                            {{--}}
