                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="input-block local-forms">
                                            ...
                                            <div class="time-icon">
                                                <input name="start" type="text" class="form-control" id="datetimepicker3">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="input-block local-forms">
                                            ...
                                            <div class="time-icon">
                                                <input name="end" type="text" class="form-control" id="datetimepicker4">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            <x-input-label for="patient" :value="__('appointment.service_type')" required/>
