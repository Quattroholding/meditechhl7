                ...
                <div class="row">
                    <div class="col-6 col-md-6 col-xl-6">
                        <div class="input-block  local-forms">
                            ...
                            <x-text-input wire:model="period_start" class="block mt-1 w-full" type="date" name="period_start"/>
                    ...
                    <div class="col-6 col-md-6 col-xl-6">
                        <div class=" input-block  local-forms ">
                            ...
                            <x-text-input wire:model="period_end" class="block mt-1 w-full" type="date" name="period_end"/>
