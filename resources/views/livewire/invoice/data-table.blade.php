                        ...
                        <table class="table border-0 custom-table comman-table mb-0">
                            ...
                            @forelse ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-primary">{{ __('invoice.status.' . ($invoice->status ?? 'draft')) }}</span>
                                        @if($invoice->payment_status)
                                            <br><small class="badge badge-secondary mt-1">{{ __('invoice.payment_status.' . $invoice->payment_status) }}</small>
                                        @endif
                                    </td>
                                    <td class="text-end">
