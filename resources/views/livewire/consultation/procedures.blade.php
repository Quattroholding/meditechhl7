<div>
                        ...
                        <table wire:click="delete({{$s->id}})">
                            ...
                            <tr>
                                ...
                                <div class="delete-multivalue">
                                    ...
                                    <span>{{ __('consultation.procedures_section.delete') }}</span>
                                </div>
                                </span>
                                </td>
                                <td>
    ...
    <input type="text"  wire:model.live="query"   class="form-control" placeholder="{{ __('consultation.procedures_section.search_placeholder') }}" >
