        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Seleccionar Plantilla de Prescripción Médica</h4>
                    <p class="small mb-0 text-warning">Elige el diseño que se usará para tus prescripciones médicas</p>
                </div>
                <div class="card-body">
                    @if(count($availableTemplates) === 0)
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            No hay plantillas de prescripción disponibles en este momento.
                        </div>
                    @else
                        <div class="row">
                                    ...
                                    <div class="card template-card h-100 {{ $selectedTemplate === $template['name'] ? 'border-primary shadow-sm' : '' }}"
                                        ...
                                        <div class="card-img-top bg-light position-relative overflow-hidden"
                                            ...
                                            <div class="template-preview-wrapper" style="width: 100%; height: 100%; transform: scale(0.35); transform-origin: top left; pointer-events: none;">
                                                <iframe
                                                    src="{{ route('setting.prescription_template.preview', $template['name']) }}"
