        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Validación de Usuarios</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Usuarios Pendientes de Validación</h4>
                    <p class="card-text">Revisa y valida los documentos de médicos registrados desde la aplicación móvil</p>
                </div>
                <div class="card-body">
