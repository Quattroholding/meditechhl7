<div class="card flex-fill dashboard-kpi-card">
    <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-2">
            <div>
                <h6 class="text-muted mb-1">Utilidad Neta (Mes)</h6>
                <h2 class="mb-0">${{ number_format($currentMonthNetUtility, 2) }}</h2>
            </div>
        ...
        <div class="mt-3">
            <small class="text-muted">Mes anterior: ${{ number_format($previousMonthNetUtility, 2) }}</small>
        </div>
    </div>
    <style>
        .dashboard-kpi-card {
