...
<section class="top">
    <div class="container top__inner">
        ...
        <div class="top__logo">
            <img src="{{url('landing/images/logoSAMIRecetas.jpg')}}" alt="SAMI Rx logo">
        </div>
...
<section class="blue">
    <div class="container">
        ...
        <div class="phones">
            <div class="phone">
                <img src="{{url('landing/images/sami_recetas_movil_registro.jpeg')}}" alt="Phone 1">
            </div>

            <div class="phone phone--mid">
                <img src="{{url('landing/images/sami_recetas_movil_dashboard.jpeg')}}" alt="Phone 2">
            </div>

            <div class="phone">
                <img src="{{url('landing/images/sami_recetas_movil_nueva_receta.jpeg')}}" alt="Phone 3">
            </div>
        </div>
        ...
        <div class="download__buttons">
            <a href="https://play.google.com/store/apps/details?id=com.meditec.recepy.meditec_recepy_app"
               ...
               class="download__button">
                <img src="{{url('images/google_play_logo_trim.png')}}" alt="Descargar en Google Play">
            </a>
            ...
            <a href="https://apps.apple.com/app/sami-recetas/id6757765164"
               ...
               rel="noopener noreferrer"
               class="download__button">
                <img src="{{url('images/apple_store_logo_trim.png')}}" alt="Descargar en App Store">
            </a>
        </div>
