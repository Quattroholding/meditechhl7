                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-xl-4" style="display: none" id="first_name">
                                    ...
                                    <div class="input-block  local-forms">
                                        ...
                                        <x-text-input class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')" required />
                                ...
                                <div class="col-12 col-md-6 col-xl-4" style="display: none" id="last_name">
                                    ...
                                    <div class="input-block  local-forms">
                                        ...
                                        <x-text-input class="block mt-1 w-full" type="text" name="last_name" :value="old('last_name')" required/>
                                ...
                                <div class="col-12 col-md-6 col-xl-4" style="display: none" id="maritalstatus">
                                    ...
                                    <!-- CLIENTS -->
                                    <div class="input-block  local-forms">
                                        <x-input-label for="gender" :value="__('user.gender')" required/>
