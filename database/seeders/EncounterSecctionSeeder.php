...
class EncounterSecctionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        EncounterSection::create([
            'name' => 'Services',
            'name_esp' => 'Servicios Facturables',
            'table_list' => '',
            'table_list_filter' => '',
        ...
        EncounterSection::create([
            ...
            'table_list' => '',
            'table_list_filter' => '',
            'livewire_component_name' => 'consultation.speciality-questions',
            'category' => 'Urologia',
            ...
            'livewire_component_fields' => [
                [
                    ...
                    'options' => '{"0":"Nada","1":"Menos de 1 de cada 5 veces","2":"Menos de la mitad de las veces","3":"Cerca de la mitad de las veces","4":"Más de la mitad de las veces","5":"Casi siempre"}',
                    'table_list_id' => '',
