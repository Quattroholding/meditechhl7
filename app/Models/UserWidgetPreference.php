    ...
    public static function getDefaultWidgets(string $dashboardType): array
    {
        $widgets = [
            'doctor' => [
                ...
                'recent-appointment-list' => ['name' => 'Recent Appointments', 'order' => 6, 'description' => 'Citas para hoy', 'width' => 'col-lg-6'],
                'patients-by-gender' => ['name' => 'Patients by Gender', 'order' => 7, 'description' => 'Pacientes por género', 'width' => 'col-lg-3'],
                'patients-by-age-block' => ['name' => 'Patients by Age Block', 'order' => 8, 'description' => 'Pacientes por Rango de Edad', 'width' => 'col-lg-3'],
                'top-active-conditions' => ['name' => 'Top Active Conditions', 'order' => 9, 'description' => 'Top 5 condicones activas', 'width' => 'col-lg-6'],
                'top-prescribed-medications' => ['name' => 'Top Prescribed Medications', 'order' => 10, 'description' => 'Top 5 medicamentos prescritos', 'width' => 'col-lg-6'],
                'consultation-effectiveness' => ['name' => 'Consultation Effectiveness', 'order' => 11, 'description' => 'Efectividad de Atención', 'width' => 'col-lg-6'],
                'activity-heatmap' => ['name' => 'Activity Heatmap', 'order' => 12, 'description' => 'Horarios de Mayor Actividad', 'width' => 'col-lg-6'],
            ],
            'assistant' => [
