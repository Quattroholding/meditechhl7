    ...
    public static function getDefaultWidgets(string $dashboardType): array
    {
        $widgets = [
            'doctor' => [
                ...
                'consultas-en-progreso' => ['name' => 'Consultas en Progreso', 'order' => 4, 'description' => 'Consultas en Progreso', 'width' => 'col-lg-3'],
                'recent-appointment-list' => ['name' => 'Recent Appointments', 'order' => 5, 'description' => 'Citas para hoy', 'width' => 'col-lg-6'],
                'patients-by-gender' => ['name' => 'Patients by Gender', 'order' => 6, 'description' => 'Pacientes por género', 'width' => 'col-lg-3'],
                'patients-by-age-block' => ['name' => 'Patients by Age Block', 'order' => 7, 'description' => 'Pacientes por Rango de Edad', 'width' => 'col-lg-3'],
                'top-active-conditions' => ['name' => 'Top Active Conditions', 'order' => 8, 'description' => 'Top 5 condicones activas', 'width' => 'col-lg-6'],
                'top-prescribed-medications' => ['name' => 'Top Prescribed Medications', 'order' => 9, 'description' => 'Top 5 medicamentos prescritos', 'width' => 'col-lg-6'],
                'consultation-effectiveness' => ['name' => 'Consultation Effectiveness', 'order' => 10, 'description' => 'Efectividad de Atención', 'width' => 'col-lg-6'],
                'activity-heatmap' => ['name' => 'Activity Heatmap', 'order' => 11, 'description' => 'Horarios de Mayor Actividad', 'width' => 'col-lg-6'],
            ],
            'assistant' => [
